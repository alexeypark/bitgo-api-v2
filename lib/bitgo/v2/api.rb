module Bitgo
  module V2
    ...
    class Api
      ...
      def list_wallet_addresses(coin, wallet_id)
      ...
      def create_address(coin, wallet_id)
      ...
      def add_webhook(coin, wallet_id, type, url, confirmations)
        add_webhook_params = {
            type: type,
            url: url,
      ...
      def list_webhooks(coin, wallet_id)
