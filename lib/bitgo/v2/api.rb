module Bitgo
  module V2
    ...
    class Api
      ...
      def get_wallet(coin: coin, wallet_id: wallet_id)
      ...
      def list_wallet_addresses(coin: coin, wallet_id: wallet_id)
      ...
      def create_address(coin: coin, wallet_id: wallet_id)
